...
3. Add:
  - Repository: `https://github.com/llellouc/bticino-myhome-hacs-byLeo`
...
`https://my.home-assistant.io/redirect/hacs_repository/?owner=llellouc&repository=bticino-myhome-hacs-byLeo&category=integration`
